...
import { PostgrestClient, PostgrestFilterBuilder, PostgrestQueryBuilder, ClientServerOptions as PostgrestClientServerOption, GetGenericDatabaseWithOptions } from '@supabase/postgrest-js';
 ...
 */
export declare type ServicesOptions = PostgrestClientServerOption & {};
export default class SupabaseClient<Database = any, ClientOptions extends ServicesOptions = {
    PostgrestVersion: '12';
